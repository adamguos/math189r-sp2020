...
if __name__ == '__main__':
    ...
    a = np.dot(X_space_stacked.transpose(), X_space_stacked)
    b = np.dot(X_space_stacked.transpose(), y_space_rand)
    ...
    plt.plot(X_space, y_space_rand, 'bo', markersize=3)
